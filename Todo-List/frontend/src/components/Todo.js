...
const addTask = (e) => {
	...
	axios.post(`${apiUrl}/addTodoList`, { task: newTask, status: newStatus, deadline: newDeadline })
	  .then(res => {
		console.log(res);
...
const saveEditedTask = (id) => {
	...
	// Updating edited data to the server through updateById API
	axios.post(`${apiUrl}/updateTodoList/${id}`, editedData)
	  .then(result => {
		console.log(result);
		setEditableId(null);
		setEditedTask("");
...
const deleteTask = (id) => {
	axios.delete(`${apiUrl}/deleteTodoList/${id}`)
	  .then(result => {
		console.log(result);
		window.location.reload();
	  })
